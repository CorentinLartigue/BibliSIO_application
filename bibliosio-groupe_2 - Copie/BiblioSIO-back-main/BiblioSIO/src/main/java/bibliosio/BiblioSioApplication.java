...
public class BiblioSioApplication {
	...
	public CommandLineRunner setUpBDD() {
		return (args) -> {
			...
			Emprunteur ER1 = new Emprunteur (1L,"Jean", "Paul", "jean.paul@gmail.com", "" ,Classe.SIO1B);
			Emprunteur ER2 = new Emprunteur(2L,"Pierre", "Feuille", "pierre.feuille@gmail.com", "" ,Classe.SIO2B);
			Emprunteur ER3 = new Emprunteur(3L,"Emprunter3", "Benoit", "Benoit@gmail.com", "" ,Classe.SIO1A);
