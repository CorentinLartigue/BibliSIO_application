...
public class EmprunteurControllerTest {
    ...
    void setUp() {
        emprunteurs = new ArrayList<>() {{
            ...
            add(new Emprunteur(4L, "Emprunter4", "Didier", "Didier@gmail.com", "" ,Classe.SIO1B));
            add(new Emprunteur(5L,"Emprunter5", "Pedro", "Pedro@gmail.com", "" ,Classe.SIO1B));
            add(new Emprunteur(28L,"Emprunter28", "Loan", "Loan@gmail.com", "" ,Classe.SIO2B));
        }};
    ...
    void whenCreatingNew_shouldReturnLink_andShouldBeStatusCreated() throws Exception {
        Emprunteur new_emprunteur = new Emprunteur(89L, "Emprunter89", "inconnu", "inconnu@gmail.com", "" ,Classe.SIO2B);
...
//Test whenUpdating_shouldReceiveUserToUpdate_andReturnNoContent
    ...
    void whenUpdating_shouldReceiveUserToUpdate_andReturnNoContent() throws Exception {
        ...
        Emprunteur updated_emprunteur = new Emprunteur(initial_emprunteur.getId(),initial_emprunteur.getNom(),initial_emprunteur.getPrenom(),initial_emprunteur.getMail(),initial_emprunteur.getPromo(),initial_emprunteur.getClasse());
        ArgumentCaptor<Emprunteur> emprunteur_received = ArgumentCaptor.forClass(Emprunteur.class);
