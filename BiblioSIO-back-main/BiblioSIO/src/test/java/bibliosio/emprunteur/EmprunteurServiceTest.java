...
public class EmprunteurServiceTest {
    ...
    void whenCreating_ShouldReturnSame() {
        Emprunteur toCreate = new Emprunteur(3L,"Emprunter3", "Benoit", "Benoit@gmail.com", "2022-2024" ,Classe.SIO1A,"Etudiant");
    ...
    void whenUpdating_shouldModifyEmprunteur() {
        ...
        Emprunteur new_emprunteur = new Emprunteur(initial_emprunteur.getId(),initial_emprunteur.getNom(),initial_emprunteur.getPrenom(),initial_emprunteur.getMail(),initial_emprunteur.getPromo(),initial_emprunteur.getClasse(), initial_emprunteur.getRole());
