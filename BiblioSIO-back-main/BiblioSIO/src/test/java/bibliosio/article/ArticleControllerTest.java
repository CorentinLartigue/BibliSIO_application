...
//Test failled whenCreatingNew_shouldReturnLink_andShouldBeStatusCreated(
    ...
    void whenCreatingNew_shouldReturnLink_andShouldBeStatusCreated() throws Exception {
        Article new_article = new Article(23L, "bidule", "sport", null);
    ...
    void whenCreatingWithExistingId_should404() throws Exception {
        ...
        mockMvc.perform(post("/article")
                .contentType(MediaType.APPLICATION_JSON)
                .content(new ObjectMapper().writeValueAsString(this.articles.get(1)))
...
//Test whenUpdating_shouldReceiveUserToUpdate_andReturnNoContent
    ...
    void whenUpdating_shouldReceiveArticleToUpdate_andReturnNoContent() throws Exception {
        ...
        Article updated_article = new Article(initial_article.getId(),initial_article.getTitre(),initial_article.getDescription(),initial_article.getExemplaire());
        ArgumentCaptor<Article> article_received = ArgumentCaptor.forClass(Article.class);
